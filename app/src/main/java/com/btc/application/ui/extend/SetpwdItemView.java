 ...
 * 自定义个人中心选项控件
 */
public class SetpwdItemView extends RelativeLayout {
    private TextView data;

    public SetpwdItemView(final Context context, AttributeSet attrs){
        super(context, attrs);
        ...
        name.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                context.startActivity(new Intent(context, Set2ndpwdActivity.class));
            }
        });
    }
