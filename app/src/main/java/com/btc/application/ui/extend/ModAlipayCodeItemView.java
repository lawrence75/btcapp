 ...
 * 自定义个人中心选项控件
 */
public class ModAlipayCodeItemView extends RelativeLayout {
    private TextView data;

    public ModAlipayCodeItemView(final Context context, AttributeSet attrs){
        super(context, attrs);
        ...
        name.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                context.startActivity(new Intent(context, ModAlipayCodeActivity.class));
            }
        });
    }
