...
public class Set2ndpwdActivity extends AppCompatActivity {

    String TAG = Set2ndpwdActivity.class.getCanonicalName();
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    if ("000000".equals(code))
                    {
                        ...
                        startActivity(new Intent(Set2ndpwdActivity.this, MainActivity.class));
                    }
                    else
                    {
